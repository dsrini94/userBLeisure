...
import RoundSelectedFlightComponent from './../components/roundSelectedFlightComponent.jsx';
  ...
  render()
  {
    ...
    return(
      <div >
            ...
            <RoundSelectedFlightComponent way={this.props.match.params.way} time1={this.props.match.params.time1} time={this.props.match.params.time} from={this.props.match.params.from} to={this.props.match.params.to}/>
