            ...
            <div className="imgHeight vhsidebar" style={{backgroundImage:"url("+this.props.notifications.backgroundImage+")"}}>
              ...
              <Grid>
                 <Grid.Row>
                   ...
                   <Grid.Column width={7}>
                    <span className="subheaders" style={{color:"white",fontSize:"14px",fontWeight:"bold"}}>{this.props.match.params.hotelname}</span>
                    <br/>
                    <span className="subheaders" style={{color:"white",fontSize:"10px",fontWeight:"bold"}}>12:00 PM,12 Dec - 12:00 PM,14 Dec</span>
                   </Grid.Column>
                   <Grid.Column width={7}>
                   <span className="subheaders" style={{color:"white",fontSize:"15px",fontWeight:"bold"}}>Booking ID</span><br/>
                   <span className="subheaders" style={{color:"white"}}> 1322789</span>
                   </Grid.Column>
                 </Grid.Row>
