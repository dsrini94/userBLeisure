...
export default class flightSummaryOnwardDetails extends React.Component {
  ...
  <Grid.Row>
    <Grid.Column>
    <center>
      <span style={{fontSize:'23px',fontWeight:'600',textDecoration:'underline',textAlign:'center',color:'#800000'}}>Onward Journey</span>
      </center>
      </Grid.Column>
  </Grid.Row>
  <Grid.Row style={{marginTop:'-15px'}}>
    <Grid.Column width={4}>
      <span style={{fontSize:'15px',fontWeight:'600'}}>FL5864</span>
    </Grid.Column>
    <Grid.Column width={4}></Grid.Column>
    <Grid.Column width={8}>
      <span style={{fontSize:'14px',fontWeight:'600',float:'right'}}>Boeing 746</span>
    </Grid.Column>
  </Grid.Row>
  <Grid.Row style={{marginTop:'-15px'}}>
    <Grid.Column>
      <span style={{fontSize:'17px',fontWeight:'bold'}}>Thursday, 21st Dec 2017</span>
    </Grid.Column>
  </Grid.Row>
  <Grid.Row style={{marginTop:'-15px'}}>
    <Grid.Column width={6}>
  ...
  <Grid.Row style={{marginTop:'-18px'}}>
    ...
    <Grid.Column width={2}>
      <span style={{fontSize:'15px',fontWeight:'500'}}>15A</span>
    </Grid.Column>
  </Grid.Row>
</Grid>
)
