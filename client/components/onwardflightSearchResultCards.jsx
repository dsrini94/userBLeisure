...
constructor(props)
{
  ...
  render() {
    ...
    return (<div>
      <Card fluid style={{
                    background:"url(./../../images/losAngeles50croppeddarkened.jpg)",
                    marginTop:"auto",
                  boxShadow:'none'}}>
        <Card.Content>
          ...
          <Grid.Row style={{marginBottom:"-20px"}}>
            <Grid.Column>
            <Header as="h6" style={{color:"white"}}>{this.props.time1}</Header>
            </Grid.Column>
          </Grid.Row>
            <Grid.Row >
              <Grid.Column>
        ...
        <Card.Content extra>
          <center>
            <Link to={`/round/${this.props.time1v}/${this.props.time2v}`}>
