 ...
 class Test extends React.Component {
   ...
   constructor(props)
   {
     ...
     cardClick(p) {
       ...
       this.setState({temp: temp,hotelamount:200});

     }

     handleCabSelect(p) {
       var temp = (<span className="subheaders">{p}</span>)
       this.setState({cab: temp,cabamount:100});
     }
   handleCabCheckBox() {
            ...
            <Grid>
              <Grid.Row>
                ...
                <center>
                  ...
                  <span className="subheaders" style={{fontSize:"10px"}}>XX301</span>
                  </center>
                </Grid.Column>
                <Grid.Column width={6}>
                <center>
                ...
                <Grid.Column width={4}>
                <center>
                  <Icon name='long left arrow' inverted size='large'/><br/>
                  <span className="subheaders" style={{fontSize:"10px"}}>XX403</span>
                  </center>
                </Grid.Column>
                <Grid.Column width={6}>
                  <center>
              ...
              <Grid.Row>
                ...
                <br/>
                <center >
                <span as='a' className="subheaders">Total ${this.state.hotelamount+this.state.cabamount+this.state.airfare}</span>
                </center>
